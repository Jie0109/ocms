                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="idea-tab-menu">
                            <ul class="nav idea-tab" role="tablist">
                                ...
                                <li><a class="active" href="paymentmethod.php">Payment Method</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="input-box mb-20">
                                                ...
                                                <div>
                                                    <h5>We provide several payment method such as Touch 'n GO and Online Bank Transfer.</h5>
                                                    <b>Kindly contact us after you have made payment.</b>
                                                    <div>
                                                        <button type="button" class="btn" data-toggle="modal" data-target="#exampleModal"><img style="width: 30px; height: 30px;" id="image" src="images/icons/tng.png" alt="GFG image" /></button>
                                                        <!-- Modal -->
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <img id="image" src="images/icons/tngacc.jpg" alt="Click on button" style="width: 470px; height: 560px;"></img>
                                                                    </div>

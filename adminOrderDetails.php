<?php
    ...
    if(isset($_POST['setS']))
    {
        $sType = $_POST['status-type'];

        $sql = "UPDATE orders SET status = '$sType' WHERE order_id =".$_GET['order_id'];
        if(mysqli_query($link, $sql))
        {
            ...
            location.href = 'adminOrderDetails.php?order_id=" . $_GET['order_id'] . "'
            })
            </script>";
        }
...
.btn-warning:hover{color: #ffffff;background-color: #ff2b00;border-color: #ff2b00;border-radius: 1px}
        ...
        <div class="container">
            <article class="card">
                <header class="card-header"> <a href="orderList.php" style="color: black;">More Orders</a> / Tracking </header>
                <form action="" method="POST">
                    <div class="card-body">
                        ...
                        <article class="card">
                            <div class="card-body row">
                                ...
                                <div class="col"> <strong>Status:</strong> <br> 
                                    <select id="status-type" style="width: 200px;" name="status-type" required >
                                        <?php
                                            $orderss = "SELECT * FROM orders WHERE order_id = ".$_GET['order_id'];
                                            $result = mysqli_query($link, $orderss);
                                            $row = mysqli_fetch_assoc($result);
                                        ?>
                        ...
                        <div class="text-end" id="payContainers" style="display: none;">
                            <input type="submit" name="setS" class="btn btn-dark" value="Save">
                        </div>
                        <hr>
                        <ul class="row">
                        <?php
                        ...
                        <hr>
                        <div>
                            <a href="orderList.php" class="btn btn-warning" data-abc="true"> <i class="fa fa-chevron-left"></i> Back to orders</a>
                        </div>
                    </div>
                </form>
            </article>
